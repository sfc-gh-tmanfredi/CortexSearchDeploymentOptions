...
CREATE OR REPLACE STREAMLIT core.FinDocSearchApp
     FROM '/'
     MAIN_FILE = 'FinDocSearchApp.py';

-- 4. Grant appropriate privileges over these objects to your application roles.
-- GRANT USAGE ON STREAMLIT core.FinDocSearchApp TO APPLICATION ROLE app_public;
GRANT USAGE ON STREAMLIT core.FinDocSearchApp TO APPLICATION ROLE app_public;
